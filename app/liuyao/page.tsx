  ...
  return (
    <main className="max-w-3xl mx-auto px-6 md:px-12 py-10 md:py-16">
      ...
      <CollapsibleIntro
        ...
        summary={
          <p>
            <span style={{ color: "var(--liuyao-bronze)" }}>六爻</span>是周易占卜最主流的方法，又称"铜钱占卦"，以三枚铜钱掷 6 次成卦。本站代你自动摇 6 次。
          </p>
        }
      >
        <p>
          变式于西汉京房易，衍发于宋明清历代易学流传，直至今日仍是民间最为广泛使用的周易占卜方法。
        </p>
        <p>
          <span style={{ color: "var(--liuyao-bronze)" }}>起卦方式</span>：取三枚铜钱（古时用乾隆/康熙通宝，现代可用三枚一元硬币）。将铜钱捧于掌心，心中想好所问之事，掷向桌面 —— 这就是初爻。共掷 6 次，从下往上依次记为初、二、三、四、五、上爻。
        </p>
        <p>每一爻的记录法则：</p>
        <div className="pl-2 space-y-1 text-[13px] md:text-sm">
