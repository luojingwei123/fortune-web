  ...
  return (
    <main className="max-w-4xl mx-auto px-6 md:px-12 py-10 md:py-16">
      ...
      <CollapsibleIntro
        ...
        summary={
          <p>
            塔罗牌源自中世纪欧洲，本站使用 1909 年 <span className="italic gold">Rider-Waite-Smith</span> 牌组共 78 张。你选一个牌阵、写一个问题、逐张凭直觉抽牌，每张牌有50%概率为逆位。
          </p>
        }
      >
        <p>
          塔罗牌共 78 张：大阿卡纳 22 张 + 小阿卡纳 56 张（权杖/圣杯/宝剑/星币四花色各 14 张）。
        </p>
        <p>本站抽牌流程：</p>
        <ol className="list-decimal list-inside space-y-1 pl-2">
          <li>你选择一个牌阵（单张 / 三张 / 凯尔特十字），写下心中的问题。</li>
          <li>系统完全洗牌（Fisher-Yates 随机打乱 78 张），将牌铺开在你面前。</li>
          <li>你凭直觉选择相应数量的牌，每张牌有 50% 概率为逆位，含义与正位相反。</li>
